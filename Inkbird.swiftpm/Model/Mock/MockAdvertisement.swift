...
public extension MockAdvertisementData {
    ...
    static let inkbirdThermometer = MockAdvertisementData(
        localName: "sps",
...
public extension InkbirdAdvertisement.Thermometer {
    ...
    static var mock: InkbirdAdvertisement.Thermometer {
        return .init(MockAdvertisementData.inkbirdThermometer)!
    }
}

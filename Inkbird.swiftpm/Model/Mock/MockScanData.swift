...
public extension MockScanData {
    ...
    static var inkbirdThermometer: MockScanData {
        MockScanData(
            peripheral: .inkbirdThermometer,
            date: Date(timeIntervalSinceReferenceDate: 10_100),
            rssi: -127,
            advertisementData: .inkbirdThermometer,
            isConnectable: true
        )
    }
}
...
public extension MockCentral.Peripheral {
    ...
    static var inkbirdThermometer: Peripheral {
        Peripheral(id: BluetoothAddress(rawValue: "49:22:08:15:04:CB")!)
    }
}
